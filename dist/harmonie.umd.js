(function (global, factory) {
	...
	*/
	...
	var helpers$1 = {
	  ...
	  toGeoJSON (gml) {
	    // convert gml to json
	    const json = parse$1.xml(gml.replace(/&lt;/g, '<').replace(/&gt;/g, '>'));
	...
	async function bb (query) {
	  ...
	  const data = parse$1.xml(query.xml);
	...
	async function nw (query) {
	  ...
	  if (incomplete) throw new Error(incomplete)
	  const data = parse$1.dataExperts(query.xml, query.gml);
